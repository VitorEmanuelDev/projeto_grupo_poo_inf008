...
public class Genius extends JPanel implements ActionListener, MouseListener{
	...
	private void criarEntradaDeDadosInicial() {
		...
		tamanhoLista = (Integer)JOptionPane.showInputDialog(null, "Escolha o n√∫mero de jogadores:", 
	...
	private class botaoAjudaListener implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(null,"                InstruÁıes\n\n"
					+ " A ideia do jogo È que v·rios botıes coloridos pisquem\n"
					+ " em alguma sequÍncia, e o usu·rio deve clicar nos botıes\n"
					+ " nessa mesma sequÍncia, com um novo flash sendo adicionado\n"
					+ " ‡ sequÍncia no inÌcio de cada rodada. Nessa implementaÁ„o,\n"
					+ " haver· quatro botıes, alguns dos quais piscar„o em uma\n" 
					+ " sequÍncia aleatÛria no inÌcio de cada rodada. Em seguida\n" 
					+ " o usu·rio deve clicar nos botıes na mesma ordem em que \n" 
					+ " piscaram. Ent„o, para cada rodada subseq¸ente, mais um \n" 
					+ " de bot„o È adicionado ao final dessa sequÍncia. O jogador\n" 
					+ " ao clicar em um bot„o que est· fora de ordem e sua pontuaÁ„o\n\n"
					+ " Existem trÍs nÌveis de jogo: f·cil, mÈdio e difÌcil.\n\n"
					+ "  - F·cil: ComeÁa na primeira fase com uma sequÍncia de um flash\n"
					+ "  - MÈdio: ComeÁa na primeira fase com uma seqÍncia de 3 flashes\n"
					+ "  - DifÌcil: ComeÁa na primeira fase com uma seqÍncia de 5 flashes\n\n"
					+ ""
					+ "    Existem trÍs nÌveis de velocidade: normal, r·pido e lento."
			);			
			}
		}
	/**
